...
The framework of these three classification models is as follows **(only for demonstration)**: the model would be added to the linear layer for transfer learning. 
